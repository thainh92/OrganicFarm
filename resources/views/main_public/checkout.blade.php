                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" class="form-control" name="first_name" id="validationTooltip01">
                                            <div class="invalid-tooltip">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" class="form-control" name="last_name" id="validationTooltip02">
                                            <div class="invalid-tooltip">
                                    ...
                                    <div class="col-lg-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" class="form-control" name="address" id="validationTooltip03">
                                            <div class="invalid-tooltip">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" class="form-control" name="phone" id="validationTooltip05">
                                            <div class="invalid-tooltip">
